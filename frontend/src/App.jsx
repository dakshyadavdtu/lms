...
function App() {
  ...
  // #region agent log
  fetch(DEBUG_LOG_ENDPOINT,{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({location:'App.jsx:render',message:'App render, hooks invoked',data:{userDataPresent:!!userData},timestamp:Date.now(),sessionId:'debug-session',hypothesisId:'H2'})}).catch(()=>{});
  // #endregion
  getCurrentUser()
  getCouseData()
